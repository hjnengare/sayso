...
export async function POST(
  ...
  try {
    ...
    const adminNotes = body.admin_notes ?? body.adminNotes ?? null;
    ...
    const message = reason
      ? `Your claim for ${business?.name ?? 'your business'} was not approved. Reason: ${reason}`
      : `Your claim for ${business?.name ?? 'your business'} was not approved. Contact support for details.`;
