...
const buttonVariants = {
  ...
  variants: {
    ...
    outline: [
      ...
      'hover:bg-card-bg-500 hover:text-white hover:shadow-sage-sm',
      'active:bg-card-bg-600 active:border-sage-600',
      'focus:ring-sage-500/30',
    ],

    ghost: [
      'text-charcoal-500 bg-transparent shadow-md',
      'hover:bg-card-bg-50 hover:text-sage-600',
      'active:bg-card-bg-100',
