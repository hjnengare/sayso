...
export default function DMPage() {
  ...
  return (
    <div className="min-h-dvh bg-off-white flex flex-col overflow-hidden relative" style={{ fontFamily: "'Urbanist', system-ui, sans-serif" }}>
      {/* Background Gradient */}
      ...
      <div className="flex-1 flex overflow-hidden min-h-0 pt-16 sm:pt-20 md:pt-20 relative z-10">
