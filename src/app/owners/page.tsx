...
import { Store, MapPin, Check, Clock } from "lucide-react";
            ...
            {businesses.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {businesses.map((business) => (
                  <div
                    key={business.id}
                    className="bg-white border border-charcoal/10 rounded-lg shadow-sm hover:border-sage/30 hover:shadow-md transition-all duration-300 p-5 sm:p-6"
                  >
