      ...
      >
        ...
        <div className="p-6 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center space-x-4 p-4 rounded-[20px] hover:bg-sage/5 transition-all duration-200 group mobile-interaction touch-target-large"
          >
          ...
          <Link
            href="/saved"
            onClick={onClose}
            className={`w-full flex items-center space-x-4 p-4 rounded-[20px] transition-all duration-200 group mobile-interaction touch-target-large relative ${
          ...
          <Link
            href="/home"
            onClick={onClose}
            className={`w-full flex items-center space-x-4 p-4 rounded-[20px] transition-all duration-200 group mobile-interaction touch-target-large ${
