  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-6 mb-4 overflow-visible">
      {Array.from({ length: 8 }).map((_, idx) => (
        <div
          key={idx}
          className="relative bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 rounded-[20px] overflow-hidden backdrop-blur-md border border-white/60 ring-1 ring-white/30 shadow-premiumElevated"
        >
