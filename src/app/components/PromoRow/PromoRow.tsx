          ...
          {PROMO_CARDS.map((card, index) => (
            ...
            >
              ...
              <div className="relative h-full p-6 flex flex-col justify-between z-10">
                <div>
                  <h3 className="font-google-sans text-lg sm:text-lg font-800 text-white mb-2">
                    {card.title}
                  </h3>
                  <p className="font-google-sans text-sm sm:text-base text-white/90">
                    {card.subtitle}
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <span className="font-google-sans text-sm sm:text-base font-700 text-white/90 transition-colors duration-300 group-hover:text-white">
                    {card.cta}
                  </span>
