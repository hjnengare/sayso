    ...
    >
      <div className="flex items-center justify-between p-3 sm:p-4">
        <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
          <div className={`w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br ${getBadgeStyles()} rounded-full flex items-center justify-center font-google-sans text-caption sm:text-body-sm font-600 shadow-[0_4px_12px_rgba(0,0,0,0.1)] flex-shrink-0 border-none`}>
          ...
          <div className="min-w-0 flex-1">
            <div className="font-google-sans text-body-sm sm:text-body font-600 text-charcoal truncate">{business.name}</div>
            <div className="font-google-sans text-caption sm:text-body-sm text-charcoal/60 flex items-center gap-1 flex-wrap">
        ...
        <div className="flex flex-col items-end gap-1 flex-shrink-0 ml-2">
          <div className="bg-gradient-to-br from-off-white via-off-white to-off-white/90 backdrop-blur-xl px-2 sm:px-3 py-1 rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.15)] border-none flex items-center gap-1">
            ...
            <span className="font-google-sans text-caption sm:text-body-sm font-600 text-charcoal">{business.reviewCount > 0 ? business.rating : "New"}</span>
          </div>
          <span className="font-google-sans text-caption sm:text-body-sm text-charcoal/70 whitespace-nowrap">{business.reviewCount > 0 ? `${business.reviewCount} reviews` : "No reviews yet"}</span>
        </div>
      </div>
    </m.div>
  );
