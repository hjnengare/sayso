...
export default function LeaderboardTitle() {
  return (
    ...
    >
      ...
      <h2 className="font-google-sans text-h2 sm:text-h1 font-600 text-charcoal mb-2">
        Top Contributors This Month
      </h2>
      <p className="font-google-sans text-charcoal/70 text-caption sm:text-body-sm max-w-md mx-auto px-2">
