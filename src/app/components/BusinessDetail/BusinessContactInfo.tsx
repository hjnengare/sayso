...
export default function BusinessContactInfo({ phone, website, address, email, location, onViewMap, showMapLink = false }: BusinessContactInfoProps) {
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border border-white/60 rounded-[12px] ring-1 ring-white/30 shadow-md p-4 sm:p-6 relative"
    >
      <div>
        <h3
