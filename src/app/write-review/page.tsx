...
import { ChevronLeft, Search, Briefcase, MapPin, ChevronRight } from "lucide-react";
              ...
              <div className="mx-auto w-full max-w-[2000px] px-2 relative z-10">
                ...
                <div className="pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20">
                  ...
                  <div className="space-y-3">
                    {isLoading ? (
                      // Skeleton loaders matching actual business card style
                      <>
                        {[1, 2, 3, 4].map(i => (
                          <div key={i} className="p-4 bg-gradient-to-br from-card-bg via-card-bg to-card-bg/95 backdrop-blur-xl border border-white/60 rounded-[20px] ring-1 ring-white/30 shadow-md">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-4">
                                {/* Business Image Skeleton */}
                                <div className="w-12 h-12 rounded-[20px] bg-sage/20 animate-pulse flex-shrink-0" />
                                <div className="space-y-2">
                                  {/* Business Name Skeleton */}
                                  <div className="h-5 bg-white/30 rounded w-36 animate-pulse" />
                      ...
                      <div className="text-center py-8">
                        <p className="text-charcoal/60">No businesses found. Try a different search.</p>
                      </div>
                    ) : (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="w-12 h-12 rounded-[20px] overflow-hidden flex-shrink-0 bg-sage/10 group-hover:bg-sage/20 transition-colors duration-200">
