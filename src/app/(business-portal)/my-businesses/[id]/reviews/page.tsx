...
export default function OwnerReviewsPage() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 max-w-5xl mx-auto font-google-sans">
      {/* Header */}
      <div className="mb-6">
        ...
        <p className="font-google-sans text-sm text-charcoal/55">
      ...
      <Link
        href={`/my-businesses/${businessId}`}
        className="inline-flex items-center gap-2 mb-6 text-charcoal/60 hover:text-charcoal font-google-sans text-sm transition-colors"
      >
        <ArrowLeft className="w-4 h-4" />
        Back to Dashboard
      </Link>
