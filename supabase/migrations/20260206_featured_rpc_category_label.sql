-- Add category_label to get_featured_businesses RPC (requires businesses.category_label from 20260205)
-- Drop the old 2-argument overload so the function name is unique (20260126 had no p_seed).
...
Includes category_label for display. Deterministic ordering via seed hash and per-bucket diversity with backfill.';
