-- =============================================
-- Fix list_businesses_optimized RPC function
-- Remove deprecated uploaded_image column
...
BEGIN
  ...
  WITH filtered_businesses AS (
    SELECT 
      ...
      b.website,
      b.image_url,
      b.uploaded_images, -- Changed from uploaded_image to uploaded_images
      b.verified,
      b.price_range,
      b.badge,
      b.slug,
...
Updated to use uploaded_images array instead of deprecated uploaded_image column.';
