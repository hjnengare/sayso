-- Migration: Fix recommend_personalized_businesses function
-- Remove deprecated uploaded_image column reference
-- Add uploaded_images array support

-- Drop and recreate the function without uploaded_image
...
RETURNS TABLE (
  ...
  website TEXT,
  image_url TEXT,
  uploaded_images TEXT[], -- Changed from uploaded_image to uploaded_images array
  verified BOOLEAN,
  price_range TEXT,
  badge TEXT,
  slug TEXT,
...
WITH candidate_businesses AS (
  SELECT
    ...
    b.website,
    b.image_url,
    b.uploaded_images, -- Changed from uploaded_image to uploaded_images array
    b.verified,
    b.price_range,
    b.badge,
    b.slug,
...
SELECT
  ...
  website,
  image_url,
  uploaded_images, -- Changed from uploaded_image to uploaded_images array
  verified,
  price_range,
  badge,
  slug,
...
'Scores businesses for personalized feeds using interest alignment, rating quality, freshness, and distance. Enforces per-sub-interest diversity to keep the feed varied. Uses uploaded_images array instead of deprecated uploaded_image column.';
